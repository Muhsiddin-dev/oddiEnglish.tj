          ...
          <div className="reveal relative">
            <div className="relative rounded-3xl overflow-hidden glass-card p-2 group/player">
              ...
              >
                ...
                {/* Vignette барои хониши беҳтари controls */}
                ...
                {/* Панели поёнӣ */}
                <div
                  className={`absolute inset-x-0 bottom-0 px-4 pb-4 pt-10 bg-gradient-to-t from-black/90 via-black/60 to-transparent flex flex-col gap-2.5 z-30 transition-opacity duration-300 ${
                    showControls || !isPlaying ? 'opacity-100' : 'opacity-0 pointer-events-none'
                  }`}
                >
                  {/* Progress bar бо hover preview */}
                  <div
